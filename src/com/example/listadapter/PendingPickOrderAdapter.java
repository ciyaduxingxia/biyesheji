...
public class PendingPickOrderAdapter extends BaseAdapter {

	private List<PickOrder> pickorderlist;
	private Context context;

	public PendingPickOrderAdapter(Context mcontext, List<PickOrder> pickorders) {
		context = mcontext;
		pickorderlist = pickorders;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		PickOrder order = pickorderlist.get(position);
		TextView pickOrderID = (TextView) view.findViewById(R.id.s_t1);
		...
		pickOrderID.setText(order.getPickOrderID());
